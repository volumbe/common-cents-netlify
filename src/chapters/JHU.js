...
import Janey from "../images/headshots/jhu/Janey_Song.jpg"
import Esther from "../images/headshots/jhu/Esther_Shin.jpg"

class JHU extends React.Component {
  render() {
    return (
        <div>            
                    ...
                    <div class = "column " data-aos="fade-down">
                        <div class="card">
                            ...
                            <figure class="image is-256x256" style = {{"width": "256px", "height": "256px", "margin-top" : "1em", "margin-left": "auto", "margin-right": "auto"}}>
                                <img class = "is-rounded"src={Janey} alt="Placeholder image"/>
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                <div class="media-content">
                                    <p class="title is-4 has-text-centered">Janey Song</p>
                    ...
                    <div class = "column " data-aos="fade-down">
                        <div class="card">
                            ...
                            <figure class="image is-256x256" style = {{"width": "256px", "height": "auto", "margin-top" : "1em", "margin-left": "auto", "margin-right": "auto"}}>
                                <img class = "is-rounded"src={Esther} alt="Placeholder image"/>
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                <div class="media-content">
                                    <p class="title is-4 has-text-centered">Esther Shin</p>
                                ...
                                <div class="content">
                                Studying Public Health and Economics. Loves to play guitar and sing, pretending to be a Kpop star.</div>
                            </div>
                        </div>
                    </div>
                </div>
